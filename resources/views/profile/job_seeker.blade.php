    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card">
                ...
                <img src="{{ $job_seeker->profile_pic ? asset('uploads/' . $job_seeker->profile_pic) : asset('images/user.png') }}" style="width: 200px; margin: auto; margin-top: -100px;" class="card-img-top rounded-circle" alt="Profile Picture">
